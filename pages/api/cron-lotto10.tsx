...
export default async function handler(req: any, res: any) {    
  ...
  myHeaders.append("Cache-Control", "no-cache");
    ...
    console.log("QUI: ", extQuery, yearQuery);
    ...
    const response = await fetch(`${process.env.LOTTO10_URL}&_it_sogei_wda_web_portlet_WebDisplayAamsPortlet_anno=${(yearQuery)}&_it_sogei_wda_web_portlet_WebDisplayAamsPortlet_prog=${extQuery}`, requestOptions);
    ...
    const label: string = $('div.estrazioni > h3').text() ?? '';

    console.log("QUI: ", label);
